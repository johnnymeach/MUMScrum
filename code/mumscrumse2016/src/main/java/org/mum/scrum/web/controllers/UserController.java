...
public class UserController 
{
	...
	private static IAdminSubSystem hrService;
	
	@Autowired
	public void setHRService(IAdminSubSystem userService) {
		UserController.hrService = userService;
	}
    ...
    public User EmployeeConstructor(){
		return new User();
    }
	...
	public static User getCurrentUser()
	{
	    ...
	    if (principal instanceof UserDetails) 
	    {
	    	...
	    	User loginUser = hrService.findUserByEmail(email);
	...
	public String addRecordEmployee(@Valid @ModelAttribute("employeeRole") EmployeeRole employeeRole
		...
		User employee=employeeRole.getEmployee();
...
//	    Encoder Authentication
	...
	public String editEmployee(@PathVariable("username") String username,Model model) {
		User employee=hrService.findEmployeeByUserName(username);	
...
//			}
//		}
		User orgEmployee=hrService.findEmployeeByUserName(username);
		if(employee==null) throw new ResourceNotFoundException();
